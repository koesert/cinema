...
public class CinemaReservationSystem
{
    ...
    public static void DrawPlan(CinemaContext db, Showtime Showtime, char selectedRow, int selectedSeatNumber)
    {
        ...
        if (basepriceseat.Price != 25) Console.WriteLine("Wegens weersomstandigheden zijn de prijzen van de stoelen van dit vertoning gewijzigd");
        Console.Write("X (normaal): ");
        Console.ForegroundColor = ConsoleColor.Blue;
        Console.Write($"{basepriceseat.Price-5},-");
        Console.ResetColor();
        Console.Write("/");
        Console.ForegroundColor = ConsoleColor.DarkYellow;
        Console.Write($"{basepriceseat.Price},-");
        Console.ResetColor();
        Console.Write("/");
        Console.ForegroundColor = ConsoleColor.Red;
        Console.Write($"{basepriceseat.Price+5},-");
        Console.ResetColor();
        Console.Write(" E (extra beenruimte): ");
        Console.ForegroundColor = ConsoleColor.Blue;
        Console.Write($"{basepriceseat.Price-5+5},-");
        Console.ResetColor();
        Console.Write("/");
        Console.ForegroundColor = ConsoleColor.DarkYellow;
        Console.Write($"{basepriceseat.Price+5},-");
        ...
        Console.Write("/");
        Console.ForegroundColor = ConsoleColor.Red;
        Console.Write($"{basepriceseat.Price+10},-");
        Console.ResetColor();
        Console.Write(" L (loveseat): ");
        Console.ForegroundColor = ConsoleColor.Blue;
        Console.Write($"{(basepriceseat.Price-5) * 2},-");
        Console.ResetColor();
        Console.Write("/");
        Console.ForegroundColor = ConsoleColor.DarkYellow;
        Console.Write($"{basepriceseat.Price*2},-");
        Console.ResetColor();
        Console.Write("/");
        Console.ForegroundColor = ConsoleColor.Red;
        Console.Write($"{(basepriceseat.Price+5) * 2},-");
